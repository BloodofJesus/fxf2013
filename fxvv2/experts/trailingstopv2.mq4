...
extern int InitialTrailingStop = 400;
...
int init()
  {
//----
   Comment("Account #",AccountNumber(), " leverage is ", AccountLeverage(), ", InitialTrailingStop #",InitialTrailingStop
...
//----
   ...
   infobox = StringConcatenate("Account #",AccountNumber(), " leverage is ", AccountLeverage(), ", InitialTrailingStop #",InitialTrailingStop
   , ", TrailingStop #",TrailingStop,"\n\n",infobox);
      Comment(infobox);
//----
   return(0);
