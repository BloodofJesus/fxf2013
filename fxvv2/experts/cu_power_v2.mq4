...
int lookupcurrency2(string symbol)
{
   timeperiod = Period();
         ...
         //infobox = infobox + " - Checking MACD";
         //infobox = infobox + "\nBuy Check 1: " + (h1 < h2 && cci > 100 && val2 > val3) + ", Buy Check 2: " + (h3 > h4 || cci2 < 100 || val4 < val5) 
         //+ ", Sell Check 1: " + (h1 > h2 && cci < -100 && val2 < val3) + ", Sell Check 2: " + (h3 < h4 || cci2 > -100 || val4 > val5);
