...
extern bool good_currency = false;
   ...
   //if (openTime != Time[0]) {
      ...
      for (index = 0; index < limit; index++) {
         ...
         */
         ...
         if (
         //(val2 < val3 && val4 > val5) 
         //|| // && aLookup[index] > aStrength[index]
         //(val6 > 100 && val6 > val7 && val2 < val3 && val8 < val9 && val10 < val11 && val12 < val13 && val14 < val15)
         //|| 
         ...
         //(val2 > val3 && val4 < val5) // && aLookup[index] < aStrength[index]
         //|| 
         //(val6 < -100 && val6 < val7 && val2 > val3 && val8 > val9 && val10 > val11 && val12 > val13 && val14 > val15)
         //|| 
         (val2 > val3 && val8 > val9 && val10 > val11 && val12 > val13 && val14 > val15)
