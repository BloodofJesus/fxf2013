   ...
   for(cnt=0;cnt<total;cnt++)
     {
      ...
      if(OrderType()<=OP_SELL  // check for opened position
         ...
         val2 = iCustom(OrderSymbol(), PERIOD_M30, "Heiken_Ashi_Smoothed",2,1);
         val3 = iCustom(OrderSymbol(), PERIOD_M30, "Heiken_Ashi_Smoothed",3,1);
